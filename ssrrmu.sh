...
check_root(){
	[[ $EUID != 0 ]] && echo -e "${Error} Script has benn run as non-root user${Green_background_prefix} sudo su ${Font_color_suffix}Trying to obtain root permission, please input the password
}
check_sys(){
